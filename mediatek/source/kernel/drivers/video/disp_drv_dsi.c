...
static void DSI_Config_VDO_Timing(void)
{
	...
	printk("[DISP] kernel - video timing, mode = %d \n", lcm_params->dsi.mode);
	printk("[DISP] kernel - VSA : %d \n", DSI_REG->DSI_VSA_NL);
	printk("[DISP] kernel - VBP : %d \n", DSI_REG->DSI_VBP_NL);
	printk("[DISP] kernel - VFP : %d \n", DSI_REG->DSI_VFP_NL);
	printk("[DISP] kernel - VACT: %d \n", DSI_REG->DSI_VACT_NL);

	printk("[DISP] kernel - HLB : %d \n", DSI_REG->DSI_LINE_NB);
	printk("[DISP] kernel - HSA : %d \n", DSI_REG->DSI_HSA_NB);
	printk("[DISP] kernel - HBP : %d \n", DSI_REG->DSI_HBP_NB);
	printk("[DISP] kernel - HFP : %d \n", DSI_REG->DSI_HFP_NB);
	printk("[DISP] kernel - RGB : %d \n", DSI_REG->DSI_RGB_NB);

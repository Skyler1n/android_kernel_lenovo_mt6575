...
# Rule: When MTK_GEMINI_3G_SWITCH =yes, then GEMINI=yes, MTK_MODEM_SUPPORT=modem_3g
...
ifeq (yes,$(strip $(MTK_GEMINI_3G_SWITCH)))
  ifneq (modem_3g,$(strip $(MTK_MODEM_SUPPORT)))
    $(call dep-err-seta-or-offb, MTK_MODEM_SUPPORT, modem_3g, MTK_GEMINI_3G_SWITCH)
  endif
endif

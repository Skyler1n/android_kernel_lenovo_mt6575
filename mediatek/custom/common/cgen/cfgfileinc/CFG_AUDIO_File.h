...
#define HD_REC_SPEECH_PARA_MONO_NUM   (8)
#define HD_REC_SPEECH_PARA_STEREO_NUM (4)
...
typedef struct _AUDIO_HD_RECORD_PARAM_STRUCT
{
    ...
    unsigned short hd_rec_speech_mode_para[HD_REC_SPEECH_PARA_MONO_NUM+HD_REC_SPEECH_PARA_STEREO_NUM][SPEECH_PARA_NUM];
    /* HD RECORD FIR */
    short          hd_rec_fir[HD_REC_FIR_INDEX_NUM][WB_FIR_NUM];

    ...
    {   //  TODO: Add your code below...
		...
		switch(rCamInfo.eIdx_ISO)
		{
			case eIDX_ISO_100:
				...
				rNR2.mode2_cfg2.bits.Y_H_FLT4 = 1;
				rNR2.mode2_cfg2.bits.Y_H_FLT5 = 1;
				rNR2.mode2_cfg2.bits.Y_H_FLT6 = 1;
				break;
			case eIDX_ISO_200:
		        rNR2.ctrl.bits.ENY = 1;
				rNR2.ctrl.bits.MODE = 1;
			...
			default:
				...
				rNR2.mode2_cfg2.bits.Y_H_FLT4 = rNR2.mode2_cfg2.bits.Y_H_FLT4;
				rNR2.mode2_cfg2.bits.Y_H_FLT5 = rNR2.mode2_cfg2.bits.Y_H_FLT5;
				rNR2.mode2_cfg2.bits.Y_H_FLT6 = rNR2.mode2_cfg2.bits.Y_H_FLT6;
				*/
				break;
		}
...
refine_CCM(RAWIspCamInfo const& rCamInfo, ISP_NVRAM_CCM_T& rCCM)
{
    				...
    				ECamMode_HDR_Cap_Pass2 ==  rCamInfo.eCamMode)
    {
		...
		unsigned int	u4LowISO=100,u4HighISO=640;

		if(rCamInfo.u4ISOValue<u4LowISO)
		{
			fRatio	= 1;
		}
		else if(rCamInfo.u4ISOValue>u4HighISO)
		{
			fRatio	= fDSaturate;
		}
		else
		{
			fRatio	= 1+(fDSaturate-1)*(rCamInfo.u4ISOValue-u4LowISO)/(u4HighISO-u4LowISO);
		}
		for (y=0; y<3; y++)
		{

...
const NVRAM_LENS_PARA_STRUCT FAKEAF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 FakeAF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &FAKEAF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFakeAF_getDefaultData = FakeAF_getDefaultData;

...
static void SIV120BInitialSetting(void)
{
  ...
  SIV120DWriteCmosSensor(0xAB,0x20);//by lingnan 
...
BOOL SIV120DSetParamEV(UINT16 para)
{
  ...
  {
    case AE_EV_COMP_n13:
      SIV120DWriteCmosSensor(0xAB,0xC8);//0xE0
      break;
    case AE_EV_COMP_n10:
      SIV120DWriteCmosSensor(0xAB,0xB8);//D0
      break;
    case AE_EV_COMP_n07:
      SIV120DWriteCmosSensor(0xAB,0xA8);//C0
      break;
    case AE_EV_COMP_n03:
      SIV120DWriteCmosSensor(0xAB,0x98);//B0
      break;
    case AE_EV_COMP_00:
      SIV120DWriteCmosSensor(0xAB,0x10);//00
      break;
    case AE_EV_COMP_03:
      SIV120DWriteCmosSensor(0xAB,0x20);//08
      break;
    case AE_EV_COMP_07:
      SIV120DWriteCmosSensor(0xAB,0x30);//10
      break;
    case AE_EV_COMP_10:
      SIV120DWriteCmosSensor(0xAB,0x40);//20
      break;
    case AE_EV_COMP_13:
      SIV120DWriteCmosSensor(0xAB,0x50);//30
      break;
    default:
      return FALSE;
  }
...
#endif
//QA thinks AE_EV_COMP_n10 too dark, temporarily set to 0x00
//AE range needs fine tune
BOOL SIV120DSetParamEV(UINT16 para)
{  
  UINT8 ab_value;
  SENSORDB("Exporsure %d\n",para);
  ...
  SIV120DCurrentStatus.iEV = para;  
  SIV120DSetPage(3);
  ab_value = SIV120DReadCmosSensor(0xAB);
  SENSORDB("before set Exporsure level %d, 0xAB reg = 0x%x\n",para,ab_value);  
  ...
  switch (para)
  {
    ...
    case AE_EV_COMP_03:
      ...
      break;
    case AE_EV_COMP_07:
      SIV120DWriteCmosSensor(0xAB,0x40);
      break;
    case AE_EV_COMP_10:
      SIV120DWriteCmosSensor(0xAB,0x50);      
      break;
    case AE_EV_COMP_13:
      SIV120DWriteCmosSensor(0xAB,0x60);
      break;
    default:
      return FALSE;
  }
  ab_value = SIV120DReadCmosSensor(0xAB);
  SENSORDB("Exporsure level %d, readfrom reg = 0x%x\n",para,ab_value);  
...
void SIV120DGetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = SIV120DCurrentStatus.iWB;
               ...
               UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
  ...
  switch (FeatureId)
  {
    ...
    case SENSOR_FEATURE_GET_EXIF_INFO:
        ...
        SIV120DGetExifInfo(*pFeatureData32);
        break;  
    default:
      break;      
  }

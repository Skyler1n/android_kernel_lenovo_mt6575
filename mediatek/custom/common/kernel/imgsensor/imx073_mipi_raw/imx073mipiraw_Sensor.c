 ...
 *
 * 02 19 2012 koli.lin
 * [ALPS00237768] [A52][??]后置camera mt9p017 AF?焦慢
 * [Camera] Modify the isp delay frame to synchrnoize with sensor exposure time and sensor gain.
 *
 * 12 02 2011 koli.lin
 * [ALPS00099487] [Must Resolve][Auto flicker detection]Preview have flicker after capture best shot or burst shot
 * [Camera] Add JPEG capture mode for ZSD.
 *
 * 11 11 2011 koli.lin
...
kal_uint32 IMX073MIPI_CAP_pclk = 2*576;
...
{	
    ...
    IMX073MIPI_write_cmos_sensor(0x0307, 0x1B);          //INCK 24MHz, 24*27=648Mbps/lane
    IMX073MIPI_write_cmos_sensor(0x3014, 0x00);
    IMX073MIPI_write_cmos_sensor(0x3015, 0x37);
    IMX073MIPI_write_cmos_sensor(0x0344, 0x0F);		// x_addr_start. 0x0344 [7:0].	0x0FF0: -16.
    IMX073MIPI_write_cmos_sensor(0x0345, 0xF0);		// x_addr_start. 0x0345 [7:0].
    IMX073MIPI_write_cmos_sensor(0x0346, 0x00);		// y_addr_start. 0x0346 [7:0].	0x0000: 0.
    IMX073MIPI_write_cmos_sensor(0x0347, 0x00);		// y_addr_start. 0x0347 [7:0].
    IMX073MIPI_write_cmos_sensor(0x0348, 0x0C);		// x_addr_end. 0x0348 [7:0].	0x0CD3: 3283.
    IMX073MIPI_write_cmos_sensor(0x0349, 0xD3);		// x_addr_end. 0x0349 [7:0].
    IMX073MIPI_write_cmos_sensor(0x034A, 0x09);		// y_addr_end. 0x034A [7:0].	0x09A1: 2465.
    IMX073MIPI_write_cmos_sensor(0x034B, 0xA1);		// y_addr_end. 0x034B [7:0].
    IMX073MIPI_write_cmos_sensor(0x034C, 0x06);		// x_output_size. 0x034C [7:0].	0x0672: 1650.
    IMX073MIPI_write_cmos_sensor(0x034D, 0x72);		// x_output_size. 0x034D [7:0].
    IMX073MIPI_write_cmos_sensor(0x034E, 0x04);		// y_output_size. 0x034E [7:0].	0x04D1: 1233.
    IMX073MIPI_write_cmos_sensor(0x034F, 0xD1);		// y_output_size. 0x034F [7:0].
...
//    IMX073MIPI_write_cmos_sensor(0x0341, 0xCE);
    ...
    IMX073MIPI_write_cmos_sensor(0x034A, 0x09);		// y_addr_end. 0x034A [7:0].	0x09A1: 2465.
    IMX073MIPI_write_cmos_sensor(0x034B, 0xA1);		// y_addr_end. 0x034B [7:0].
    IMX073MIPI_write_cmos_sensor(0x034C, 0x0C);		// x_output_size. 0x034C [7:0].	0x0CE4: 3300.
    IMX073MIPI_write_cmos_sensor(0x034D, 0xE4);		// x_output_size. 0x034D [7:0].
    IMX073MIPI_write_cmos_sensor(0x034E, 0x09);		// y_output_size. 0x034E [7:0].	0x09A2: 2466.
    IMX073MIPI_write_cmos_sensor(0x034F, 0xA2);		// y_output_size. 0x034F [7:0].
    IMX073MIPI_write_cmos_sensor(0x0381, 0x01);
    IMX073MIPI_write_cmos_sensor(0x0383, 0x01);
    IMX073MIPI_write_cmos_sensor(0x0385, 0x01);
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
        		switch(CurrentScenarioId)
        		{
        			case MSDK_SCENARIO_ID_CAMERA_ZSD:
        			case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		            *pFeatureReturnPara32 = 57600000*2; //19500000;
		            *pFeatureParaLen=4;		         	
		         		break;

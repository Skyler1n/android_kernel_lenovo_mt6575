...
struct i2c_driver mt6329_driver = {                       
    ...
    .detect = mt6329_driver_detect,                           
    .driver.name = "mt6329_pmic",                 
...
{             
	...
	//pmic_dump_register();
	//pmic_interface_test();
	//pmic_get_chip_version_v2();
	//pmic_buck_interface_test();
	//pmic_ldo_interface_test();
	//pmic_auxadc_test();
	//pmic_chr_test();
...
{	
	...
	if(i2c_add_driver(&mt6329_driver)!=0)
	{
		xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6329_init] failed to register pmic i2c driver.\n");
	}
	else
	{
		xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[mt6329_init] Success to register pmic i2c driver.\n");
	}

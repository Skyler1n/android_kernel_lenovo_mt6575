...
/**
 * The original implementation DOES support dynamic interface number.
 * However, some special function driver such as ACM class, the interface
 * number will be also used in other class-specific descriptor. Those descriptors
